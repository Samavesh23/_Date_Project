...
{   
    ...
    NSString *currntDate=[self.formatter stringFromDate:[NSDate date]];
    _minimumDate = [self.formatter dateFromString:currntDate];
...
- (void)requestBoundingDatesIfNecessary
{
    if (_needsRequestingBoundingDates) {
        ...
        self.formatter.dateFormat = @"yyyy-MM-dd";
         NSString *currntDate=[self.formatter stringFromDate:[NSDate date]];
        _minimumDate = [self.dataSourceProxy minimumDateForCalendar:self]?:[self.formatter dateFromString:currntDate];
