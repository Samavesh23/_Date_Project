...
- (void)initialize
{
    ...
    UIButton *leftBtn = [[UIButton alloc] initWithFrame:CGRectMake(20, 20, 20, 20)];
    ...
    collectionView.backgroundColor =[UIColor colorWithRed:(251/255.0) green:(49/255.0) blue:(79/255.0) alpha:1.0];
    ...
    [self.collectionView addSubview:leftBtn];
}
