...
static ViewAlertPosition _EHAlertPosition = ViewAlertPositionTop;
...
+ (void)updateColorsDictionary
{
    if (!_EHColorsDictionary)
    {
        _EHColorsDictionary = [@{ @(ViewAlertError) : [UIColor colorWithHex:0xFDB937],
                                  ...
                                  @(ViewAlertInfo) :  [UIColor colorWithHex:0xDEB887],
...
+ (void)updateIconsDictionary
{
    ...
    {
        _EHIconsDictionary = [@{ @(ViewAlertError) : [EHPlainAlert imageNamed:@"40.png"],
                                  @(ViewAlertSuccess) : [EHPlainAlert imageNamed:@"40.png"],
                                  @(ViewAlertInfo) :  [EHPlainAlert imageNamed:@"40.png"],
                                  @(ViewAlertPanic) :[EHPlainAlert imageNamed:@"40.png"]
                                  } mutableCopy];
    }
}
- (void)viewDidLoad
