...
@interface FutureDatesVC ()
@property (nonatomic, strong) NSMutableArray *cellSizes;
@property (nonatomic, strong) NSArray *cats;
@end

@implementation FutureDatesVC
...
- (void)viewDidLoad {
    ...
    _adBannerr.adUnitID = ADUNIT_320x50_ROS;
    _adBannerr.rootViewController = self;
    [_adBannerr loadRequest:[DFPRequest request]];
...
-(void)viewDidAppear:(BOOL)animated
{
    ...
    favoriteArray=[[[DataBase sharedChatTableClass]getdataByUserId:[[AppHelper userDefaultsForKey:@"userdata"] valueForKey:@"id"]]mutableCopy];
...
- (void)performTask:(NSNotification *)Data
{
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SchedulePlan *fav=[favoriteArray objectAtIndex:indexPath.row];
